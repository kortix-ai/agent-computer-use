...
impl CdpConnection {
    pub async fn connect(port: u16) -> agent_click_core::Result<Self> {
    ...
    async fn connect_ws(ws_url: &str, port: u16) -> agent_click_core::Result<Self> {
    ...
    async fn discover_ws_url(port: u16) -> agent_click_core::Result<String> {
    ...
    ) -> agent_click_core::Result<serde_json::Value> {
    ...
    pub async fn evaluate(&self, expression: &str) -> agent_click_core::Result<serde_json::Value> {
        let result = self
            .send(
                "Runtime.evaluate",
...
fn cache_path(port: u16) -> PathBuf {
    ...
    PathBuf::from(format!("{home}/.agent-click/cdp-{port}.json"))
}
