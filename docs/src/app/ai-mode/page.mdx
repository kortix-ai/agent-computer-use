...
```json
{"error": true, "type": "element_not_found", "message": "no element found matching selector chain"}
```

Elements:

```json
{"role": "button", "name": "Submit", "value": null, "position": {"x": 450, "y": 320}, "enabled": true}
```
